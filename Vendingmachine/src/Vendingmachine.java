...
public class Vendingmachine extends JFrame 
{
	...
	public Vendingmachine()
	{
		...
		물_재고_추가=new JButton("재고 1 증가");
		물_재고_추가.setEnabled(false);
		물_재고_추가.setFont(new Font("맑은 고딕",Font.BOLD,15));
		물_재고_추가.setLocation(810, 180);
		물_재고_추가.setSize(120,30);
		물_재고_추가.addActionListener(new Water_Stock_Plus());
		c.add(물_재고_추가);
		...
		커피_재고_추가=new JButton("재고 1 증가");
		커피_재고_추가.setEnabled(false);
		커피_재고_추가.setFont(new Font("맑은 고딕",Font.BOLD,15));
		커피_재고_추가.setLocation(810, 230);
		커피_재고_추가.setSize(120,30);
		커피_재고_추가.addActionListener(new Coffee_Stock_Plus());
		c.add(커피_재고_추가);
		...
		이온음료_재고_추가=new JButton("재고 1 증가");
		이온음료_재고_추가.setEnabled(false);
		이온음료_재고_추가.setFont(new Font("맑은 고딕",Font.BOLD,15));
		이온음료_재고_추가.setLocation(810, 280);
		이온음료_재고_추가.setSize(120,30);
		이온음료_재고_추가.addActionListener(new Ion_Stock_Plus());
		c.add(이온음료_재고_추가);
		...
		프리미엄커피_재고_추가=new JButton("재고 1 증가");
		프리미엄커피_재고_추가.setEnabled(false);
		프리미엄커피_재고_추가.setFont(new Font("맑은 고딕",Font.BOLD,15));
		프리미엄커피_재고_추가.setLocation(810, 330);
		프리미엄커피_재고_추가.setSize(120,30);
		프리미엄커피_재고_추가.addActionListener(new Premium_Coffee_Stock_Plus());
		c.add(프리미엄커피_재고_추가);
		...
		탄산음료_재고_추가=new JButton("재고 1 증가");
		탄산음료_재고_추가.setEnabled(false);
		탄산음료_재고_추가.setFont(new Font("맑은 고딕",Font.BOLD,15));
		탄산음료_재고_추가.setLocation(810, 380);
		탄산음료_재고_추가.setSize(120,30);
		탄산음료_재고_추가.addActionListener(new Soda_Stock_Plus());
		c.add(탄산음료_재고_추가);
		...
		오십원_재고_추가.addActionListener(new Fifty_Won_Plus());
		c.add(오십원_재고_추가);
		...
		오백원_재고_추가.addActionListener(new Five_Hundred_Won_Plus());
		c.add(오백원_재고_추가);
	...
	/*상품 재고 증가 버튼*/
	//물 재고 증가
	private class Water_Stock_Plus implements ActionListener{
		public void actionPerformed(ActionEvent e)
		{
	...
	//커피 재고 증가
	private class Coffee_Stock_Plus implements ActionListener{
		public void actionPerformed(ActionEvent e)
		{
	...
	//이온음료 재고 증가
	private class Ion_Stock_Plus implements ActionListener{
		public void actionPerformed(ActionEvent e)
		{
	...
	//프리미엄커피 재고 증가
	private class Premium_Coffee_Stock_Plus implements ActionListener{
		public void actionPerformed(ActionEvent e)
		{
	...
	//탄산음료 재고 증가
	private class Soda_Stock_Plus implements ActionListener{
		public void actionPerformed(ActionEvent e)
		{
	...
	/*거스름돈 재고 증가버튼*/
	private class Ten_Won_Plus implements ActionListener{
		public void actionPerformed(ActionEvent e)
		{
			change.ten++;
			십원_재고.setText(Integer.toString(change.ten));
	...
	private class Fifty_Won_Plus implements ActionListener{
		public void actionPerformed(ActionEvent e)
		{
			change.fifty++;
			오십원_재고.setText(Integer.toString(change.fifty));
	...
	private class One_Hundred_Won_Plus implements ActionListener{
		public void actionPerformed(ActionEvent e)
		{
			change.one_hund++;
			백원_재고.setText(Integer.toString(change.one_hund));
	...
	private class Five_Hundred_Won_Plus implements ActionListener{
		public void actionPerformed(ActionEvent e)
		{
			change.five_hund++;
			오백원_재고.setText(Integer.toString(change.five_hund));
	...
	private class One_Thousand_Won_Plus implements ActionListener{
		public void actionPerformed(ActionEvent e)
		{
			change.one_thousand++;
			천원_재고.setText(Integer.toString(change.one_thousand));
